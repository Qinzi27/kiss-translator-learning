...
当前版本：**`2.0.36-learning.7`（预发布）**。新增设置内的 **插件更新** 页面，以及网页 / PDF 侧边翻译按钮的状态图案与自定义颜色。原 Python 更新工具、PDF 双语阅读、后两页预翻译、会话缓存和安全修复继续保留。Chrome 内文件夹更新尚未完成真实安装环境的端到端验收；使用前请阅读[更新说明](UPDATING.md)、[PDF 阅读说明](docs/PDF-READER.md)与[安全与升级说明](SECURITY.md)。
